...
def main():
    ...
    specs={
        "valid.lab.local":(365,"valid.lab.local"),
        "information.lab.local":(50,"information.lab.local"),
        "warning.lab.local":(20,"warning.lab.local"),
        "expiring.lab.local":(5,"expiring.lab.local"),
        "expired.lab.local":(-1,"expired.lab.local"),
        "mismatch.lab.local":(365,"other.lab.local"),
        "chain.lab.local":(365,"chain.lab.local"),
        "app.wild.lab.local":(365,"*.wild.lab.local"),
    }
    for host,(days,cert_cn) in specs.items():
